...
onClickOutside(target, () => server.open = false)

</script>

<template lang='pug'>
.flex.flex-col.overflow-hidden.rounded-lg.shadow-xl.z-1000.absolute.bg-light-100.dark_bg-dark-400.left-20.right-20.top-20(v-if="server.open" ref="target")
